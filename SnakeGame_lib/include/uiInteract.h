...
public:
   ...
   int  isDown()       const { return isDownLongPress;   };
   bool isDownShort()  const { return isDownShortPress;  };
   int  isUp()         const { return isUpLongPress;     };
   bool isUpShort()    const { return isUpShortPress;    };
   int  isLeft()       const { return isLeftLongPress;   };
   bool isLeftShort()  const { return isLeftShortPress;  };
   int  isRight()      const { return isRightLongPress;  };
   bool isRightShort() const { return isRightShortPress; };
   bool isSpace()      const { return isSpaceShortPress; };
   bool isEnter()      const { return isEnterShortPress; };
   bool isESC()        const { return isEscapeShortPress;   };
...
private:
   ...
   static int  isDownLongPress;     /// is the down arrow currently pressed?
   static bool isDownShortPress;    ///    "   down short  "
   static int  isUpLongPress;       ///    "   up          "
   static bool isUpShortPress;      ///    "   up short    "
   static int  isLeftLongPress;     ///    "   left        "
   static bool isLeftShortPress;    ///    "   left short  "
   static int  isRightLongPress;    ///    "   right       "
   static bool isRightShortPress;   ///    "   right short "
   static bool isSpaceShortPress;   ///    "   space       "
   static bool isEnterShortPress;   ///    "   enter       "
   static bool isEscapeShortPress;  ///    "   esc         "
};
