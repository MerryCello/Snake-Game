...
void Interface::keyEvent(int key, bool fDown) {
   switch(key) {
      case GLUT_KEY_DOWN:
         isDownLongPress  = fDown;
         isDownShortPress = fDown;
         break;
      case GLUT_KEY_UP:
         isUpLongPress  = fDown;
         isUpShortPress = fDown;
         break;
      case GLUT_KEY_RIGHT:
         isRightLongPress  = fDown;
         isRightShortPress = fDown;
         break;
      case GLUT_KEY_LEFT:
         isLeftLongPress  = fDown;
         isLeftShortPress = fDown;
         break;
      case GLUT_KEY_HOME:
      case ' ':
         isSpaceShortPress = fDown;
         break;
      case '\r':
         isEnterShortPress = fDown;
         break;
      case (char)27:
         isEscapeShortPress = fDown;
         break;
   }
}
/***************************************************************
...
void Interface::keyEvent() {
   ...
   /// Disallows continual press
   isUpShortPress     = false;
   isDownShortPress   = false;
   isLeftShortPress   = false;
   isRightShortPress  = false;
   isSpaceShortPress  = false;
   isEnterShortPress  = false;
   isEscapeShortPress = false;
}
 ...
 **************************************************/
int          Interface::isDownLongPress    = 0;
bool         Interface::isDownShortPress   = false;
int          Interface::isUpLongPress      = 0;
bool         Interface::isUpShortPress     = false;
int          Interface::isLeftLongPress    = 0;
bool         Interface::isLeftShortPress   = false;
int          Interface::isRightLongPress   = 0;
bool         Interface::isRightShortPress  = false;
bool         Interface::isSpaceShortPress  = false;
bool         Interface::isEnterShortPress  = false;
bool         Interface::isEscapeShortPress = false;
...
void Interface::initialize(int argc, char ** argv, const char * title, Point topLeft, Point bottomRight) {
   ...
   glClearColor(GRAY_DARK("r"), GRAY_DARK("g"), GRAY_DARK("b"), 0);  /// Window background color
